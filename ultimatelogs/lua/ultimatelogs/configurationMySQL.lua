...
ULogs.MySQLite_config.Username         = "ulog"             -- The username to log in on the MySQL server
ULogs.MySQLite_config.Password         = "xxxx"             -- The password to log in on the MySQL server

ULogs.MySQLite_config.Database_name    = "ulog"         -- The name of the Database on the MySQL server
